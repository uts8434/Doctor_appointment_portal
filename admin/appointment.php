        ...
        <div class="dash-body">
            <div class="appointment-container">
                ...
                <div style="display: flex; justify-content: center; align-items: center; ">
                    <a href="appointment.php" style="margin-right: 1.8em;">
                        <button class="back-btn">
                             <span class="tn-in-text">Back</span>
                        </button>
                    </a>
                    <div>
                        <p class="appointment-title">Appointment Manager</p>
                    </div>
                </div>
                ...
                <!-- Date Section -->
                <div style="display:flex; justify-content:center; align-items:center;">
                    <div class="date-container" style="margin-right: 10px;">
            ...
            <table border="0"  style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                    ...
                    <div class="popup">
                        <center>
                            ...
                            <div class="content">
                                ...
                                Patient Name: &nbsp;<b>' . $nameget . '</b><br>
                                Appointment number &nbsp; : <b>' . $apponum . '</b><br><br>
