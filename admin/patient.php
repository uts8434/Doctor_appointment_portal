...
<body>
    ...
    <div class="parent">
        ...
        <div class="dash-body">
            ...
            <div class="header_nav" style="margin-top:3%;">
                <div>
                    <a href="schedule.php">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <tr>
                    <td colspan="4" style="padding-top:10px; background-color:#dadada">
                        <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:royalblue">All Patients (<?php echo $list11->num_rows; ?>)</p>
                    </td>
                                ...
                                <table width="93%" class="sub-table scrolldown" style="border-spacing:0;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-headin"> AYUSHMAN CARD NUMBER:</th>
                                        ...
                                        if ($result->num_rows == 0) {
                                            ...
                                            for ($x = 0; $x < $result->num_rows; $x++) {
                                                ...
                                                echo '<tr>
                                                                    ...
                                                                    <td>' . substr($nic, 0, 12) . ' </td>' . substr($tel, 0, 10) . ' </td>
